...
class Game:
    ...
    def show_game_over(self):
        ...
        line1 = myfont.render(f"Game is over! Your score is {self.snake.length}", True, (255, 255, 255))
        self.surface.blit(line1, (200, 300))
        line2 = myfont.render("To play again press Enter. To exit press Escape!", True, (255, 255, 255))
